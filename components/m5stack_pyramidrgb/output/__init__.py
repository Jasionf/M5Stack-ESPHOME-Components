...
from .. import m5stack_pyramidrgb_ns, CONF_PYRAMIDRGB_ID, BASE_SCHEMA

CODEOWNERS = ["@Jasionf"]
DEPENDENCIES = ["m5stack_pyramidrgb"]

PyramidRGBOutput = m5stack_pyramidrgb_ns.class_("PyramidRGBOutput", output.FloatOutput)
RGBColorChannel = m5stack_pyramidrgb_ns.enum("RGBColorChannel", is_class=True)
