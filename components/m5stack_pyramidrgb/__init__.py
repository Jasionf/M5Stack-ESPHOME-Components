...
CONF_PYRAMIDRGB_ID = "m5stack_pyramidrgb_id"
CONF_STRIP = "strip"
...
m5stack_pyramidrgb_ns = cg.esphome_ns.namespace("m5stack_pyramidrgb")
PyramidRGBComponent = m5stack_pyramidrgb_ns.class_("PyramidRGBComponent", cg.Component, i2c.I2CDevice)
