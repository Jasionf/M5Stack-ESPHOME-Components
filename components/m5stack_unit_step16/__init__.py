...
m5stack_unit_step16_ns = cg.esphome_ns.namespace("m5stack_unit_step16")
UnitStep16Component = m5stack_unit_step16_ns.class_("UnitStep16Component", cg.Component, i2c.I2CDevice)
OutputChannel = m5stack_unit_step16_ns.enum("OutputChannel", is_class=True)

CONF_UNIT_STEP16_ID = "m5stack_unit_step16_id"
