...
from .. import m5stack_unit_step16_ns, CONF_UNIT_STEP16_ID

CODEOWNERS = ["@m5stack"]
DEPENDENCIES = ["m5stack_unit_step16"]

UnitStep16Output = m5stack_unit_step16_ns.class_("UnitStep16Output", output.FloatOutput)
